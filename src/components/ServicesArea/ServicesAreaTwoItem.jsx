...
const ServicesAreaTwoItem = ({ item }) => {
  return (
    <div className="services-item-two wow fadeInUp" data-wow-delay=".2s" style={{marginTop:"-20px"}}>
      {/* <div className="services-icon-two">{item.icon}</div> */}
      {/* <div className="services-icon-two"><img src={item.img} alt="" style={{height:'35px'}} /></div> */}

      <div className="services-content-two" style={{height:'160px', marginTop:'-50px'}}>
        <h2 className="title">
